...
obj_fixtra_bresties_penalized_new <- function(event, time, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, SmoothMatrix, lambda_i, SplineType = "pspline", parallel = FALSE, threads = 1L) {
    .Call(`_surtvep_obj_fixtra_bresties_penalized_new`, event, time, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, SmoothMatrix, lambda_i, SplineType, parallel, threads)
}
