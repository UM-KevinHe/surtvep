...
surtiver_fixtra_fit_penalizestop <- function(event, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, lambda_spline, SmoothMatrix, effectsize, SplineType = "pspline", method = "Newton", lambda = 1e8, factor = 1.0, parallel = FALSE, threads = 1L, tol = 1e-10, iter_max = 20L, s = 1e-2, t = 0.6, btr = "dynamic", stop = "incre", TIC_prox = FALSE, fixedstep = TRUE, difflambda = FALSE, penalizestop = FALSE, ICLastOnly = FALSE) {
    .Call('_surtvep_surtiver_fixtra_fit_penalizestop', PACKAGE = 'surtvep', event, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, lambda_spline, SmoothMatrix, effectsize, SplineType, method, lambda, factor, parallel, threads, tol, iter_max, s, t, btr, stop, TIC_prox, fixedstep, difflambda, penalizestop, ICLastOnly)
}

surtiver_fixtra_fit_penalizestop_bresties <- function(event, time, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, lambda_spline, SmoothMatrix, effectsize, SplineType = "pspline", method = "Newton", lambda = 1e8, factor = 1.0, parallel = FALSE, threads = 1L, tol = 1e-10, iter_max = 20L, s = 1e-2, t = 0.6, btr = "dynamic", stop = "incre", TIC_prox = FALSE, fixedstep = TRUE, difflambda = FALSE, penalizestop = FALSE, ICLastOnly = FALSE) {
    .Call('_surtvep_surtiver_fixtra_fit_penalizestop_bresties', PACKAGE = 'surtvep', event, time, count_strata, Z_tv, B_spline, theta_init, Z_ti, beta_ti_init, lambda_spline, SmoothMatrix, effectsize, SplineType, method, lambda, factor, parallel, threads, tol, iter_max, s, t, btr, stop, TIC_prox, fixedstep, difflambda, penalizestop, ICLastOnly)
}
