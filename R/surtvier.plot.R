...
#' Plotting result from surtvier() function
#'
...
#' 
#' @examples
surtvier.plot <- function(fit, coef){
  ...
  colnames(beta_low) <- paste0(fit$z.names,"_low")
  colnames(beta_up) <- paste0(fit$z.names,"_up")
