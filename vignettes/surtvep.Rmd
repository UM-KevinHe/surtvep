...
Simply look at the plots using the `plot` function:
...
We can use the following codes to get the baseline estimation and the baseline plot.

```{r}
base <- coxtp.baseline(IC.support$model.mAIC)
```
