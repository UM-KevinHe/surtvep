...
<img src="Flowchart.png" alt="Flowchart" width="400" height="500">
...
fit.smoothspline <- coxtp(event = event, z = z, time = time, lambda = lambda_spline_all, penalty = "Smooth-spline")
```
