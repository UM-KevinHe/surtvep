...
* **`V1`**: Simulated covariate V1, Binary variable with 0, 1. True time-dependent function is b(t)=1}
* **`V2`**: Simulated covariate V2, Binary variable with 0, 1. True time-dependent function is b(t)=exp(-1.5*t)}
...
* **`V1`**: Simulated covariate V1, Binary variable with 0, 1. True time-dependent function is b(t)=1}
* **`V2`**: Simulated covariate V2, Binary variable with 0, 1. True time-dependent function is b(t)=sin(3\emph{pi}t/4)}
* **`V3`**: Simulated covariate V2, Binary variable with 0, 1. True time-dependent function is b(t)=-1}
* **`V4`**: Simulated covariate V2, Binary variable with 0, 1. True time-dependent function is b(t)=(t/3)**2\emph{exp(t/2)}
* **`V5`**: Simulated covariate V2, Binary variable with 0, 1. True time-dependent function is b(t)=exp(-1.5}t)}
* **`event`**: Simulated event variable, Binary varible with 0, 1 }
* **`time`**: Simulated time variable, Continous variable with non-negative value}
